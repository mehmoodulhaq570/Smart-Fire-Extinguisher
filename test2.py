# Detect fire in the image and give the coordinates
...
image_path = "fire.jpg"  # Change this to your image file path
...
for result in results:
    for box in result.boxes:
        ...
        if conf > 0.5:  # Process only confident detections
            ...
            cv2.putText(image, f"Angle: {theta_x_degrees:.2f}Â°", (x1, y1 - 20),
